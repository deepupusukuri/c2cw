...
import { GraduationCap, Compass, ClipboardList } from "lucide-react";
  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
      <div className="space-y-4 lg:col-span-2">
        ...
        {programs?.length === 0 && (
          <div className="card">
            <EmptyState icon={GraduationCap} title="No programs yet" description="Create one from the Overview tab." />
          </div>
        )}
      ...
      <div className="space-y-6">
        ...
        <InfoPanel
          ...
          items={[
            ...
            "Trainers can also view and manage the same enrollments from their dashboard.",
